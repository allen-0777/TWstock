...
def api_for_buy_sell():
    ...
    buy_top50_table = df_buy_top50.to_json(orient='records')
    sell_top50_table = df_sell_top50.to_json(orient='records')
    return render_template('for_buy_sell.html', all=df_all, buy_top50_table=buy_top50_table, sell_top50_table=sell_top50_table, date=data_date)
